...
func TestLegacyBehaviour(t *testing.T) {
	...
	go func() {
		...
		directorFn := func(ctx context.Context, fullMethodName string) (context.Context, proxy.CloseableClientConnInterface, error) {
...
func backendDialer(t *testing.T, opts ...grpc.DialOption) (proxy.CloseableClientConnInterface, error) {
	t.Helper()
...
func backendSvcDialer(t *testing.T, addr string, opts ...grpc.DialOption) (proxy.CloseableClientConnInterface, error) {
	opts = append(opts,
		grpc.WithInsecure(),
		grpc.WithBlock(),
	)
