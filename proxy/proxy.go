...
func NewProxy(dst CloseableClientConnInterface, opts ...grpc.ServerOption) *grpc.Server {
...
func DefaultProxyOpt(cc CloseableClientConnInterface) grpc.ServerOption {
...
// calls.
func DefaultDirector(cc CloseableClientConnInterface) StreamDirector {
	return func(ctx context.Context, fullMethodName string) (context.Context, CloseableClientConnInterface, error) {
